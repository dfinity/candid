...
pub fn create_union_array_type(typed_array: &str, elem_type: &str) -> TsType {
...
pub fn create_interface_from_record(
    enum_declarations: &mut HashMap<Vec<Field>, (TsEnumDecl, String)>,
    env: &TypeEnv,
    id: &str,
    ty: &Type,
...
pub fn create_type_alias_from_function(
    enum_declarations: &mut HashMap<Vec<Field>, (TsEnumDecl, String)>,
    env: &TypeEnv,
    id: &str,
    func: &Function,
...
// Create TS property signature from Candid field
pub fn create_property_signature_for_variant(
    enum_declarations: &mut HashMap<Vec<Field>, (TsEnumDecl, String)>,
    env: &TypeEnv,
    field: &Field,
) -> TsTypeElement {
