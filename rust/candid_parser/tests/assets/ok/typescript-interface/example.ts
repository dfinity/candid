...
import type { tree as _tree, B as _B, node as _node, A as _A, a as _a, List as _List, list as _list, stream as _stream, b as _b } from "declarations/example/example.did.d.ts";
