...
function to_candid_opt_n2(value: Some<B> | None): [] | [_B] {
    return value.__kind__ === "None" ? candid_none() : candid_some(to_candid_B_n3(value.value));
}
function to_candid_opt_n4(value: Some<C> | None): [] | [_C] {
    return value.__kind__ === "None" ? candid_none() : candid_some(to_candid_C_n5(value.value));
}
