...
SKIP_FILES=("bad_comment" "bad_import" "bad_import2" "bad_import3" "collision_arguments" "collision_fields" "collision_fields2" "comment" "invalid_cyclic" "not_func" "not_serv" "oneway" "surrogate" "underline")
