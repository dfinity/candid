...
fn test_error() {
    ...
    let test_vec =  b"DIDL\x01m\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00||\x00\xf7\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x19\x12&\x00\x00\xfb\x00\x00\x00\x00\x00/\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xba\x00\x1aR?\x00@\x00\x00\x00\x00\x00\x00\x00\x00+++++++++++\xab+++++++++++\xe2\x80\x81++++++\x00\x00\x00\x00\x00\x00\x01\xe9+++++3+++++++DIDL\x01l\x81\x01|]\x00\x00\x00\x00\x00".to_vec();
    check_error(
        || Decode!(test_vec.as_slice()).unwrap(),
